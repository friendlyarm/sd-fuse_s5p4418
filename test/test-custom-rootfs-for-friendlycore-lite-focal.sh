...
wget http://${HTTP_SERVER}/dvdfiles/S5P4418/rootfs/rootfs-friendlycore-lite-focal.tgz
...
(cd friendlycore-lite-focal/rootfs/root/ && {
	wget http://${HTTP_SERVER}/dvdfiles/S5P4418/images-for-eflasher/friendlycore-lite-focal-images.tgz -O deleteme.tgz
});
